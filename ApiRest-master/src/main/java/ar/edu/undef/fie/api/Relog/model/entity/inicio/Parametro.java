package ar.edu.undef.fie.api.Relog.model.entity.inicio;
...
public class Parametro {
    ...
    public ParametroResponse representation() {
        return new ParametroResponse(id,usuario,gan_por_op,per_por_op,variacion_entr_caidas);
    }
}
